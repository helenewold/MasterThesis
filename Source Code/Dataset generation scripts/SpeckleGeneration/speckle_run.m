...
%     path_ = '/Figures/Server/Lelm';
%     basepath = '/uio/hume/student-u55/helenewo/MasterThesis/MasterThesis';
% end

%% Parameter creation
% path = fullfile('C:\Users\Helene\Documents\Elektronikk, informatikk og teknologi\Master Thesis', 'MT SourceCode','Field II datasets', 'speckle');
% file_name = 'tst.uff';
% 
% path = fullfile('C:\Users\Helene\Documents\Elektronikk, informatikk og teknologi\Master Thesis','Datasets');

% path = fullfile('\\hume.uio.no\student-u55\helenewo\MasterThesis','datasets', 'largeset');
path = 'datasets'
file_name = 'specklesim_v2.uff';
...
channel_data.data = 0.1*channel_data.data(:,:,:,1);
...
% Lelm_set=0;
% calc_param = 0;
% % b_data_MLA_delayed = beamformed_data;
% script_post_getCapon
% b_data_mv_getCapon = mv_getCapon.go();
