%% Script explanation
% Skriptet viser resultat av histogram matching for datasettet 
% FieldII_noSpeckle10scats_5degs.uff. 
%
% Oppdatert: 17.11.22
clear
close all
...
fig3 = figure(3);
b_data_out.plot(fig3, "Histogram matching - DAS w/getCapon", 60, 'none');
caxis([-60 0])

%% Figure saving block
if exist('save_fig','var') && save_fig
%     savefig(fig1, "DAS_"    + file_name,     path = "DAS_Outputs")
    savefig(fig2, "getCapon_" + file_name,     path = "getCapon_Outputs")
